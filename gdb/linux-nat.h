...
/* async file mark, trigger next event */
void async_file_mark (void);

/* async file flush, flush existing evnet */
void async_file_flush (void);

/* enable/disable linux nat async evnet */
void linux_nat_async (struct target_ops *ops, int enable);

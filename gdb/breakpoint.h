...
enum bptype
  {
    ...
    /* CNGDB - breakpoints */
    /* CNGDB internal breakpoint for error reporting, hit when a driver
       API returns an error. */
    bp_cngdb_driver_api_error,

    /* CNGDB internal breakpoint for error reporting, hit when create a
       driver internal error. */
    bp_cngdb_driver_internal_error,
...
struct bp_target_info
{
  ...
  /* CNGDB */
  bool cngdb_breakpoint_location;
};
...
struct breakpoint
  {
    ...
    bool cngdb_breakpoint;  /* flag true if this is a cngdb device breakpoint */
  };
...
extern void cngdb_mark_all_breakpoint_not_inserted (void);

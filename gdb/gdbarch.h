...
extern int gdbarch_float16_bit (struct gdbarch *gdbarch);
extern void set_gdbarch_float16_bit (struct gdbarch *gdbarch, int float16_bit);

extern const struct floatformat ** gdbarch_float16_format (struct gdbarch *gdbarch);
extern void set_gdbarch_float16_format (struct gdbarch *gdbarch, const struct floatformat ** float_format);

                      ...
                      struct language_arch_info *lai)
{
  ...
  lai->primitive_type_vector [c_primitive_type_float16] = builtin->builtin_float16;
...
enum cplus_primitive_types {
  ...
  cplus_primitive_type_decfloat16,
                          ...
                          struct language_arch_info *lai)
{
  ...
  lai->primitive_type_vector [cplus_primitive_type_decfloat16]
    = builtin->builtin_float16;
